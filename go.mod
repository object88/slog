module github.com/object88/slog
...
require (
	...
	github.com/dgryski/go-mph v0.0.0-20190213215745-a6142d986d0e // indirect
	...
	k8s.io/metrics v0.0.0-20190228180609-34472d076c30 // indirect
